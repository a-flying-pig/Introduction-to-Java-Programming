...
import chapter27_graph_and_application.AbstractGraph;
...
public class WeightedGraph<V> extends AbstractGraph<V> {
	...
	/** Construct a WeihgtedGraph from edges and vertices in arrays */
	public WeightedGraph(int[][] edges, V[] vertices) {
		super(edges, vertices);
		createQueues(edges, vertices.length);
	}
	
	/** Construct a WeihgtedGraph from edges and vertices in List */
	protected WeightedGraph(int[][] edges, int numberOfVertices) {
		super(edges, numberOfVertices);
		// TODO Auto-generated constructor stub
		createQueues(edges, numberOfVertices);
	}
	
	/** Construct a WeihgtedGraph from vertices 0, 1, 2 and edge list */
	...
	/** Get a minimum spanning tree root at vertex 0 */
	...
	public ShortestPathTree getShortestPatch(int sourceIndex) {
		// T stares the vertices whose patch found so far
		List<Integer> T = new ArrayList<Integer>();
	...
	public class ShortestPathTree extends Tree {
		...
		/** Print patch from all vertices to the source */
