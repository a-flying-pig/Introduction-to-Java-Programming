...
public class TestShortestPath {
		...
		public static void main(String[] args) {
			...
			int[][] edges = {
					...
					{5, 0, 2097}, {5, 3, 1003}, {5, 4, 533}, {5, 6, 983}, {5, 7, 214},
					{6, 5, 983}, {6, 7, 214},
			...
			WeightedGraph<String>.ShortestPathTree tree1 = graph1.getShortestPatch(5);
			tree1.printAllPaths();
			...
			WeightedGraph<Integer>.ShortestPathTree tree2 = graph2.getShortestPatch(3);
			tree2.printAllPaths();
		}
}
