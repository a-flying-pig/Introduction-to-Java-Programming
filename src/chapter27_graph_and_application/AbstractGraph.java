...
public abstract class AbstractGraph<V> implements Graph<V> {
	...
	protected AbstractGraph(List<Edge> edges, int numberOfVerticies) {
	...
	/** Return the degree with the specified index */
	...
	public class Tree {
		...
		private List<Integer> searchOders; // Store the search order
		
		/** Construct a tree with root, parent, and searchOrder */
		public Tree (int root, int[] parent, List<Integer> searchOrders) {
			this.root = root;
			this.parent = parent;
			this.searchOders = searchOrders;
		}
