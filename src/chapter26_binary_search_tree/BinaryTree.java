...
import chapter25_list_stack_queue_priority_queue.MyArrayList;
...
public class BinaryTree<E extends Comparable<E>> 
	...
	public ArrayList<TreeNode<E>> patch(E e) {
	...
	class InorderIterator implements Iterator<E> {
		...
		/** Remove the current element and move cursor to the next */
		public void remove() {
